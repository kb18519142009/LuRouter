package com.example.bai.utils.router.bundle;
...
import com.example.bai.utils.annotation.WebRequest;
            ...
            if (methodForRequest == null) {
                ...
                for (Method method : methods) {
                    ...
                    if (handlerInstance == null && !Modifier.isStatic(method.getModifiers())) {
                        throw new RuntimeException("Handler specified for \"" + path + "\" is non-static method!");
                    }
